...
#define JSI_HOST_OBJECT_CONSTRUCTOR(NAME) \
  NAME(jsi::Runtime &runtime, const jsi::Object &thisValue, const jsi::Value *args, size_t argc): RnJSI::HostClass()
...
namespace RnJsi {
  template <typename T>
  class HostClass: public facebook::jsi::HostObject {
  public:
    HostClass() = default;
    ...
    static jsi::Function getConstructor(jsi::Runtime &runtime) {
      return JSI_DEFINE_FUNCTION(runtime, constructor, 0, JSI_BIND_METHOD(constructor));
    }
